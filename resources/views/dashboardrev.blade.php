            ...
            @foreach($articles as $article)
                ...
                <tr>
                    ...
                    <td class="px-4 py-2">
                        ...
                        @endforeach
                        <form action="{{ route('admin.addTag', $article->id) }}" method="POST" class="inline">
                            @csrf
                            <input type="text" name="tag_name" placeholder="Agregar etiqueta" class="border border-gray-300 px-2 py-1 rounded">
                            <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded">Agregar</button>
                        </form>
                    </td>
                    <td class="px-4 py-2">
